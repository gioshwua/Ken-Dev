...
const CV = './Kenneth-Joshua-Reaño-CV.pdf';
const Footer = () => {
  return (
    <footer className="w-full lg:max-w-screen-md flex flex-col justify-center items-center mx-auto">
      ...
      <AnimationContainer customClassName="w-full grid place-items-center grid-cols-3 gap-1 lg:gap-4 pb-8 sm:grid-cols-3 mx-3">
        ...
        <div className="flex flex-col space-y-4">
          <ExternalLink href="https://github.com/gioshwua">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
          ...
          <ExternalLink href="https://linkedin.com/in/gioshwua">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
          ...
          <ExternalLink href="https://x.com/gioshwua_">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
        ...
        <div className="flex flex-col space-y-4">
          ...
          <a
            href={CV}
            download="Kenneth Joshua Reano-CV.pdf"
            className="flex items-center gap-2 text-gray-500 hover:text-gray-600 transition ease"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
